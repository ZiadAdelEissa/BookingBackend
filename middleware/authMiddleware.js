...
export const isAuthenticated = (req, res, next) => {
  console.log('🔐 Auth check - Session exists:', !!req.session.user._id);
  console.log('🔐 Session user:', req.session.user._id ? { id: req.session.user._id, email: req.session.user.email, role: req.session.user.role } : 'null');
